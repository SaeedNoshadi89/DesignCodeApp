...
var featuredCourses = [
    Course(title: "SwiftUI for iOS 16", subtitle: "20 sections - 3 hours", text: "Build an iOS app for iOS 16 with custom layouts, animations and ...", image: "Illustration 5", background: "Background 5", logo: "Logo 2"),
    Course(title: "UI Design for iOS 16", subtitle: "20 sections - 3 hours", text: "Design an iOS app for iOS 16 with custom layouts, animations and ...", image: "Illustration 3", background: "Background 4", logo: "Logo 4"),
...
var courses = [
    Course(title: "SwiftUI for iOS 16", subtitle: "20 sections - 3 hours", text: "Build an iOS app for iOS 16 with custom layouts, animations and ...", image: "Illustration 9", background: "Background 5", logo: "Logo 2"),
